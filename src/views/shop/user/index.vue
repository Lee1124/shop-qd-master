<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <!-- 操作 -->
      <el-table-column v-if="checkPermission(['admin','YXUSER_ALL','YXUSER_EDIT','YXUSER_DELETE'])" label="操作" width="240" align="center" fixed="right">
        <template slot-scope="scope">
          <!-- 修改等级 -->
          <el-button
...
import gForm from './formg'
import { formatTime } from '@/utils/index'
export default {
  components: { eForm, pForm, gForm },
  mixins: [initData],
  data() {
    return {
      delLoading: false,
